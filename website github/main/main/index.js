...
webSocket.addEventListener("message", (event) => {
  ...
  if (data.d.discord_user) {
    if (data.d.listening_to_spotify) {
      ...
      kebab = document.getElementById("kebab");
      kebab.textContent = `Şu anda bir şey dinlemiyorum!`
    }
  }
})
...
var rain = new Howl({
    src: './main/assets/rain.mp3',
    volume: 0.2
  })

  var bigThunder = new Howl({
    src: './main/assets/thunder_start.mp3',
    volume: 0.5
  })
  ...
  var thunder = new Howl({
    src: ['./main/assets/thunder_sprite.mp3'],
  ...
  if (firstFlash = true) {
    ...
    console.log('dsdsdsds') //development
